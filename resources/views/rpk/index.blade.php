        ...
        <tbody>
             @foreach($RPK as $dataRPK)
                        <tr id="attachment" class="item">
                            ...
                            <td>
                                <select style="width:160px; font-size: 10px; font-weight: bold;" name="rincian_program" type="text" id="rincian_program" class="rincian_program d-inline form-control w-auto required">
                                <option id="po" value="SILAHKAN PILIH" >SILAHKAN PILIH</option>
