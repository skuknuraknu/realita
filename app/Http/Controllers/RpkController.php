...
{  
    ...
    {
        $RPK = DB::SELECT( DB::RAW("SELECT tb_rpk.*, tb_ik.kode_ik, tb_ik.indikator_kinerja, tb_prog.program FROM tb_rpk INNER JOIN tb_ik ON tb_rpk.kode_ik = tb_ik.kode_ik INNER JOIN tb_prog ON tb_prog.kode_prog = tb_rpk.kode_program"));
